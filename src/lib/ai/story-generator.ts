...
function previewPrompt(input: StoryInput, attempt = 0) {
  ...
  return [
    ...
    "Make the ending_hook cinematic and behavioral, not essay-like: avoid narrator questions such as 'what truth will be revealed?' as the final beat.",
    "The ending_hook should feel like this sequence: the old message changes to read, the phone shows a small typing indicator blinking, rain or silence tightens the moment, and the protagonist's frozen finger must choose one direction.",
    "End immediately after the typing-indicator tension peaks. Do not explain the truth yet; make the paid branch feel necessary.",
